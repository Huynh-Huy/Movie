...
// node_modules/@coreui/bootstrap-vue/dist/index.es.js
  ...
  setup(props, { slots, emit }) {
    ...
    const initPopper = () => {
      ...
      if (dropdownRef.value) {
        popper2.value = createPopper(dropdownRef.value, dropdownMenuRef.value, {
...
var CDropdownMenu = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const { alignment, dark, popper: popper2, visible } = toRefs(config);
    ...
    return () => h(props.component, {
      ...
      ...(typeof alignment.value === "object" || !popper2.value) && {
...
var CDropdownToggle = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => dropdownVariant === "nav-item" ? h("a", {
      active: props.active,
...
var M = (() => {
  ...
  }, e.defaults = {}, e.sensibleDefaults = void 0, e.config = n, e.custom = k, e.oneOf = D, e.instanceOf = Y, e.oneOfType = L, e.arrayOf = F, e.objectOf = B, e.shape = I, e.utils = { validate: (e2, t3) => true === m(t3, e2, true), toType: (e2, t3, r2 = false) => r2 ? _(e2, t3) : j(e2, t3) }, t2;
})();
function R(e = { func: () => {
...
var CFormCheck = defineComponent({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    const formLabel = () => {
      return h(CFormLabel, {
        customClassName: props.button ? [
          "btn",
          props.button.variant ? `btn-${props.button.variant}-${props.button.color}` : `btn-${props.button.color}`,
          {
    ...
    return () => props.button ? [formControl(), (slots.label || props.label) && formLabel()] : props.label ? h("div", {
      class: [
        "form-check",
        {
    ...
    }, [formControl(), props.label && formLabel()]) : formControl();
  }
});
 ...
 */
//# sourceMappingURL=@coreui_bootstrap-vue.js.map
