<template>
  ...
  <div
    class="d-flex justify-content-between align-items-center bg-white border my-0 py-0"
  ...
  >
    <div class="d-flex flex-row">
      <router-link to="/result"
        ><button
          @click="getFilmBo()"
          class="btn p-2 bd-highlight header-link btn-no"
        >
          Phim bộ
        </button></router-link
      >
      <router-link to="/result"
        ><button @click="getFilmLe()" class="btn p-2 bd-highlight header-link">
          Phim lẻ
        </button>
      </router-link>
      <router-link to="/result"
        ><button
          @click="getFilmHoatHinh()"
          class="btn p-2 bd-highlight header-link"
        >
          Hoạt hình
        </button></router-link
      >
      ...
      <router-link to="/history">
        <button class="btn p-2 bd-highlight header-link">Lịch sử</button>
      </router-link>
    </div>
    <div class="">
